...
function DirectionCompass({ directionData, windDirectionDeg, windSpeed }) {
  ...
  const directions = useMemo(() => {
    ...
    if (Array.isArray(directionData)) {
      ...
      list = directionData.direction_weather;
    }
...
export default React.memo(DirectionCompass);
